...
final class ProductionConfigurationValidator {
    ...
    static void validate(Environment environment) {
        ...
        requireValue(environment, "spring.ai.openai.embedding.model");
        requireEquals(environment, "spring.ai.model.chat", "openai");
        requireEquals(environment, "spring.ai.model.embedding", "openai");
        requireTrue(environment, "spring.flyway.enabled");

        requireEquals(environment, "java-ai.knowledge.context-source", "retrieval");
        requireTrue(environment, "java-ai.knowledge.ingestion.enabled");
        requireJdbcUrl(environment, "java-ai.knowledge.postgres.jdbc-url");
        requireValue(environment, "java-ai.knowledge.postgres.username");
        requireValue(environment, "java-ai.knowledge.postgres.password");
        requireValue(environment, "java-ai.knowledge.object-store.local-root");
        ...
        requireValue(environment, "java-ai.security.jwt.allowed-actors");
