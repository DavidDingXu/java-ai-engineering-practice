...
import com.xiaoding.javaai.rag.service.DocumentChunker;
...
import com.xiaoding.javaai.rag.service.SimpleDocumentParser;
...
class DocumentPipelineTest {
    ...
    void chunksMarkdownByHeadingAndCopiesMetadataToEachChunk() {
        ...
        List<com.xiaoding.javaai.rag.service.DocumentChunk> chunks = chunker.chunk(document);
